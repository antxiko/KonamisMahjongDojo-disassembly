...
def main():
    ...
    traza = json.load(open(os.path.join(work, "mahjong.trace.json")))
    blocks = traza["blocks"]
    notas = rangos_d(os.path.join(src, "mahjong.notes"))
